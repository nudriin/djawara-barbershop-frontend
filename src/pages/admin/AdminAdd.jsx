            ...
            <section className="flex items-center justify-center min-h-screen text-white bg-slate-900">
                <div className="w-9/12 p-6 space-y-5 border rounded-xl border-lime">
                    <div className="flex flex-col items-center justify-center gap-2">
                        ...
                        <h1 className="mt-3 text-3xl text-center font-futura">Tambah Admin</h1>
                    ...
                    <form className="grid grid-cols-12 gap-4">
                        ...
                        <button onClick={handleRegister} className="w-full col-span-12 p-2 mb-4 rounded-lg bg-lime text-slate-900 hover:bg-purple hover:text-white">Tambah</button>
                    </form>
                </div>
            </section>
        </AdminLayout>
